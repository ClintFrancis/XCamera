...
{
	public class XCameraCaptureViewOld : ViewGroup, Camera2Basic.ICameraPreview, INativeCameraView
	{
		...
		public XCameraCaptureViewOld(Context context, CameraOptions option) : base(context)
		{
			CameraOption = option;
